...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_config_path", type=str, default="cfg/yolov3plate.cfg", help="path to model config file")
    parser.add_argument("--data_config_path", type=str, default="cfg/plate.data", help="path to data config file")
